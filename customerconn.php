<?php
  ...
  if (isset($_POST['csub'])) {
     ...
     $query = "INSERT INTO customer (CUSTOMER_NAME, PICTURE, EMAIL, GENDER, CNIC_NUMBER, PASSWORD, DATE_OF_BIRTH, CITY, COUNTRY, REVIEW) VALUES ('$name', '$img', '$email', '$gender', '$nic', '$password', '$dob', '$city', '$country', '$review')";

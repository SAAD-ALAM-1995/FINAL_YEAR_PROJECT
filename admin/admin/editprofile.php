...
<div class="modal fade" id="updatedob" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
         ...
         <?php
          ...
          if (isset($_GET['uid'])) {
           $id = $_GET['uid'];
            ...
            $q = "SELECT DATE_OF_BIRTH FROM customer WHERE CUSTOMER_ID = '$id'";
          ...
          <div class="form-group">
    <input type="hidden" class="form-control" name="id" value="<?php echo $row['DATE_OF_BIRTH']?>">
   </div> 
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="date_of_birth" placeholder="Enter DATE_OF_BIRTH">
  </div>
         ...
         <?php
          ...
          if (isset($_GET['uid'])) {
           $id = $_GET['uid'];
            ...
            $q = "SELECT CITY FROM customer WHERE CUSTOMER_ID = '$id'";
          ...
          <div class="form-group">
    <input type="hidden" class="form-control" name="id" value="<?php echo $row['CITY']?>">
   </div> 
         ...
         <?php
          ...
          if (isset($_GET['uid'])) {
           $id = $_GET['uid'];
            ...
            $q = "SELECT COUNTRY FROM customer WHERE CUSTOMER_ID = '$id'";
          ...
          <div class="form-group">
    <input type="hidden" class="form-control" name="id" value="<?php echo $row['COUNTRY']?>">
   </div> 
      ...
      <div class="modal-body">
       ...
       <form action="../connection/adminconn.php" method="POST">
         <?php
          ...
          <div class="form-group">
<input type="hidden" class="form-control" name="id" value="<?php echo $row['CUTOMER_ID']?>">
   </div> 

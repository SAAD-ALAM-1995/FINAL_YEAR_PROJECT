...
<div class="modal fade" id="updatepassword" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
         ...
         <?php
          ...
          if (isset($_GET['uid'])) {
           $id = $_GET['uid'];
            ...
            $q = "SELECT PASSWORD FROM admin WHERE AD_ID = '$id'";
          ...
          <div class="form-group">
    <input type="hidden" class="form-control" name="adid" value="<?php echo $row['PASSWORD']?>">
   </div> 
  ...
  <button type="submit" name="password_up_btn" class="btn text-white">UPDATE</button>

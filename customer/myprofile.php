      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          require '../connection/conn.php';
            ...
            $q = "SELECT PICTURE FROM customer WHERE EMAIL = '$i'";
            ...
            if ($res) {
             ...
             <?php echo '<img src="../images/'.$row['PICTURE'].'" id="img" class="rounded-circle">';?>
     ...
     <div class="row">
        ...
        <div class="col-md-5">
          ...
          require '../connection/conn.php';
            ...
            $q = "SELECT EMAIL FROM customer WHERE EMAIL = '$i'";
    ...
    <div class="row">
        ...
        <div class="col-md-5"> 
          ...
          require '../connection/conn.php';
            ...
            $q = "SELECT GENDER FROM customer WHERE EMAIL = '$i'";
        ...
        <div class="col-md-5">
          ...
          require '../connection/conn.php';
            ...
            $q = "SELECT CNIC_NUMBER FROM customer WHERE EMAIL = '$i'";
    ...
    <div class="row">
        ...
        <div class="col-md-5"> 
          ...
          require '../connection/conn.php';
            ...
            $q = "SELECT DATE_OF_BIRTH FROM customer WHERE EMAIL = '$i'";
        ...
        <div class="col-md-5">
          ...
          require '../connection/conn.php';
            ...
            $q = "SELECT CITY FROM customer WHERE EMAIL = '$i'";
    ...
    <div class="row">
        ...
        <div class="col-md-5"> 
          ...
          require '../connection/conn.php';
            ...
            $q = "SELECT COUNTRY FROM customer WHERE EMAIL = '$i'";

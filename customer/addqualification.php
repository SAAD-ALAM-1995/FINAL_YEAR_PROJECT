...
<html>
 ...
 <li class="nav-item dropdown">
  ...
  <li class="nav-item">
    ...
    <br>
  <form action="../connection/professionalconn.php" method="POST" enctype="multipart/form-data">
   ...
   <div class="form-group">
      ...
      <input type="hidden" class="form-control" name="proid" value="<?php echo $row['CUSTOMER_ID'];?>">
    </div>
    ...
    <div class="form-group">
     ...
     <select id="inputState" name="ptype" class="form-control" required>
    ...
    <div class="form-group">
      <label>Fees</label>
      <input type="text" class="form-control" name="fees" id="exampleFormControlFile1" placeholder="Enter Fees" required >
    </div>

    <div class="form-group">
      <label>University name</label>
      <input type="text" class="form-control" name="university" id="exampleFormControlFile1" placeholder="Enter University name" required>
    </div>
    ...
    <div class="form-group">
      <label>DEGREE</label>
      <input type="file" class="form-control" name="degree" id="exampleFormControlFile1" required>
    </div>
    ...
    <div class="form-group">
      <label>TYPE</label>
      <input type="text" class="form-control" name="type" id="exampleFormControlFile2" placeholder="ENTER YOUR TYPE" required>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="designation" id="exampleFormControlFile3" placeholder="ENTER YOUR DESIGNATION" required>
      <small class="text-dark"> Where are you recently work </small>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="experience" id="exampleFormControlFile4" placeholder="ENTER YOUR EXPERINCE" required>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="file" class="form-control-file" name="mcertificate" id="exampleFormControlFile5" required>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="file" class="form-control-file" name="icertificate" id="exampleFormControlFile6" required>
    </div>

    <div class="form-group">
      <label>SCHOOL NAME</label>
      <input type="text" class="form-control" name="scname" placeholder="Enter School Name" required>
    </div>

    <div class="form-group">
      <label>COLLAGE NAME</label>
      <input type="text" class="form-control" name="coname" placeholder="Enter Collage Name" required>
    </div>

    
    <button type="submit" class="btn" name="qasub" value="submit"> Submit </button>

...
<html>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
  	...
  	<ul class="nav ml-auto">
  		 <li class="nav-item">
        <a class="nav-link text-dark" href="userpanel.php">Home</a>
      </li>
   <li class="nav-item">
 ...
 <li class="nav-item dropdown">
  ...
  <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(3).jpg" class="rounded-circle mimg"  alt="...">
         </div>

        <div class="col-md-8  ">
    <p class="card-text m-3 font-weight-bold">Adnan Admed  </p> 

     <p class="card-text m-3">for reviews  is simply dummy text of the printing and typesetting industry. </p>

          </div>

          <div class="col-md-3 text-center"> 9/8/19 8:55 </div> 

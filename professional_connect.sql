...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2019 at 10:41 PM
...
(2, 'hello saad', 9, '2019-10-20', '00:00:00.000000', 8, 'chat'),
(3, 'how are you', 9, '2019-10-20', '00:00:00.000000', 8, 'chat'),
(4, 'hello saad', 10, '2019-10-20', '00:00:00.000000', 8, 'chat'),
(5, 'hello mustafa', 8, '2019-10-20', ' \r\n\r\n\r\n  01:28:00am\r\n        ', 9, 'chat'),
(6, 'how are you', 9, '2019-10-20', ' \r\n\r\n\r\n  01:36:14am\r\n        ', 10, 'chat');
...
INSERT INTO `customer` (`CUSTOMER_ID`, `CUSTOMER_NAME`, `PICTURE`, `EMAIL`, `GENDER`, `CNIC_NUMBER`, `PASSWORD`, `DATE_OF_BIRTH`, `CITY`, `COUNTRY`, `REVIEW`) VALUES
(8, 'mustafa', 'mustafa.jpg', 'mustafahassan12at@gmail.com', 'Male', 2147483647, '5c0f785a91625ed552376ed0701a741a', '1998-01-02', 'karachi', 'Pakistan', 'Review'),
(9, 'Saad Alam', 'saadalam.jpg', 'saad_alam9522@yahoo.com', 'Male', 2147483647, 'cfbf799328dd0ae4b223099404b8bde9', '1995-01-01', 'karachi', 'Pakistan', 'Review'),
(10, 'Saad usmani', 'saadusmani.jpg', 'saadusmani@gmail.com', 'Male', 2147483647, 'cfbf799328dd0ae4b223099404b8bde9', '1995-01-01', 'karachi', 'Pakistan', 'Review');
...
ALTER TABLE `rate`
  ...
  ADD UNIQUE KEY `CUSTOMER_ID` (`CUSTOMER_ID`),
  ADD UNIQUE KEY `FOREIGN KEY` (`PRO_ID`) USING BTREE;
...
--
ALTER TABLE `connection`
  MODIFY `CON_ID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
